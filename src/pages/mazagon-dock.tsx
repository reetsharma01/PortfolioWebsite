  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0E0E0E', fontFamily: 'Poppins, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 0, margin: 0 }}>
      <div style={{ background: '#1A1A1A', borderRadius: 18, boxShadow: '0 2px 16px #C6282822', padding: '2.5rem 2rem', minWidth: 340, maxWidth: 540, textAlign: 'center', position: 'relative' }}>
        ...
        <h1 style={{ color: '#C62828', fontFamily: 'Poppins, sans-serif', fontWeight: 900, fontSize: '2.2rem', letterSpacing: '0.04em', marginBottom: 18 }}>Mazagon Dock Shipbuilders Limited</h1>
        <div style={{ color: '#B0BEC5', fontWeight: 500, fontSize: '1.1rem', marginBottom: 18 }}>Engineering Intern, EY Design Department</div>
        ...
        <div style={{ color: '#B0BEC5', fontSize: '1.08rem', fontWeight: 400, lineHeight: 1.7 }}>
          Assisted in engineering design and analysis, contributing to key projects in shipbuilding and industrial design.
        </div>
      </div>
    </div>
  );
